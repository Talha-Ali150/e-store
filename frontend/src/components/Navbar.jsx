...
const Navbar = () => {
  ...
  return (
    <div className="navbarMainContainer flex flex-col  items-center x mx-auto p-2 sticky top-0 bg-gradient-to-r from-sky-500 to-purple-500 z-10 text-white sm:flex sm:flex-row">
      <div className="flex justify-between  w-[90%] mt-3">
        ...
        <p className="flex sm:hidden" onClick={toggleNavbar}>
